AntiTrust - Random Room Name Update

Perubahan terbaru:
- Nama room sekarang otomatis dan acak.
- User tidak perlu menulis nama room di halaman depan.
- Admin juga membuat room dengan nama otomatis dan acak.
